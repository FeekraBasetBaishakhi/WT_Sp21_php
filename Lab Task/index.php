	...
	<body>
		...
		<form action="" method="post">
			<table>
				...
				<td>:
					<input type="checkbox" name="hobbies" value=""><?php echo $hobbies;?><span>Movies </span>
					<input type="checkbox" name="hobbies" value=""><?php echo $hobbies;?><span> Music </span>
					<input type="checkbox" name="hobbies" value=""><?php echo $hobbies;?><span>Games </span>
					<input type="checkbox" name="hobbies" value=""><?php echo $hobbies;?><span> Garden </span>
					<span><?php echo $err_hobbies;?></span></td>
				</tr>
				<tr>
					<td><span>Profession:</span></td>
					<td>:
						<select name="profession"><?php echo $profession;?>
					<option disabled selected>Chose One</option><?php echo $profession;?>
					<option>Teaching</option><?php echo $profession;?>
					<option>Service</option><?php echo $profession;?>
					<option>Business</option><?php echo $profession;?>
					</select>
